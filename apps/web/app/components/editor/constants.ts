...
export const TOOL_ITEMS: Array<{ id: EditorTool; label: string; hint: string }> = [
  ...
  { id: "comment", label: "Comment", hint: "Attach a visible page note" },
  { id: "ink", label: "Ink", hint: "Draw freehand strokes" },
  { id: "strike", label: "Strike", hint: "Mark text with a red line" },
  { id: "sticky", label: "Sticky", hint: "Place a compact note" },
  { id: "redact", label: "Redact", hint: "Permanently remove page content" },
